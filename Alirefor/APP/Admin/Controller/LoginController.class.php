...
class LoginController extends Controller {
	...
	/*public  function index(){
	  echo "<script>alert('该后台已停用'); </script>";
                  //  echo "<script>javascript:parent.window.location.href= 'http://www.text.com/CT/index.php?m=Admin&c=Index&a=index'</script>";
  echo "<script>javascript:parent.window.location.href= 'http://106.15.137.174/Alirefor/index.php?m=Home&c=Index&a=index'</script>";
	 //   $this->display();
	}*/
