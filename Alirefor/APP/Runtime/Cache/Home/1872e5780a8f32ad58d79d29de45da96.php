                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable "
                            ...
                            <tbody id="ad">
                            <?php if(is_array($shop)): $i = 0; $__LIST__ = $shop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($ko["buy_time"]); ?></td>
                                    <td><?php echo ($ko["account_Name"]); ?></td>
                                    ...
                                    <td><?php echo ($ko["name"]); ?>:<?php echo ($ko["GainItems"]["count"]); ?></td>
                                    <td><?php echo ($ko["currency_use"]["0"]["MoneyTypes"]); ?>:<?php echo ($ko["currency_use"]["0"]["count"]); ?></td>
                                    <td><?php echo ($ko["currency_left"]["0"]["MoneyTypes"]); ?>:<?php echo ($ko["currency_left"]["0"]["count"]); ?></td>
