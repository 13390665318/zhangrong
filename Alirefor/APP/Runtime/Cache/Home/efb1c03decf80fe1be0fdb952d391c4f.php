...
<div id="page-wrapper">
    ...
    <?php if(is_array($clostu)): $i = 0; $__LIST__ = $clostu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["db_id"]) == $db_id): ?><option value="<?php echo ($vo["db_id"]); ?>" selected="selected"><?php echo ($vo["clothes"]); ?></option>
            ...
            <option value="<?php echo ($vo["db_id"]); ?>"><?php echo ($vo["clothes"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                            ...
                            &nbsp&nbsp
                            <div>查看相关&nbsp&nbsp
                                <button class="btn btn-default" id="rid" onclick="Skill()" value="<?php echo ($record["0"]["rid"]); ?>">技能
                                </button>
                                &nbsp&nbsp
                                <button class="btn btn-default" id="rid" onclick="Wings()" value="<?php echo ($record["0"]["rid"]); ?>">翅膀
                                </button>
                                &nbsp&nbsp
                                <button class="btn btn-default" id="rid" onclick="Rong()" value="<?php echo ($record["0"]["rid"]); ?>">荣耀
                                </button>
                                &nbsp&nbsp
                                <button class="btn btn-default" id="rid" onclick="Star()" value="<?php echo ($record["0"]["rid"]); ?>">星耀
                                </button>
                                &nbsp&nbsp
                                <button class="btn btn-default" id="rid" onclick="Mount()" value="<?php echo ($record["0"]["rid"]); ?>">坐骑
                                </button>
                                &nbsp&nbsp
                                <button class="btn btn-default" id="rid" onclick="Pet()" value="<?php echo ($record["0"]["rid"]); ?>">宠物
                                </button>
                                &nbsp&nbsp
                                <button class="btn btn-default" id="rid" onclick="Equip()" value="<?php echo ($record["0"]["rid"]); ?>">装备
                                </button>
                                &nbsp&nbsp
                                <button class="btn btn-default" id="rid" onclick="Backb()" value="<?php echo ($record["0"]["rid"]); ?>">
                                    背包信息
                                </button>
                                &nbsp&nbsp
                                <button class="btn btn-default" id="rid" onclick="Task()" value="<?php echo ($record["0"]["rid"]); ?>">任务
                                </button>
                                &nbsp&nbsp
                                <button class="btn btn-default" id="rid" onclick="Emaill()" value="<?php echo ($record["0"]["rid"]); ?>">邮箱
                                </button>
                            </div>
                            <span id="jianli" style="display:none">&nbsp账号建立日期&nbsp&nbsp<input class="form-control"
                                                                                               disabled="disabled"
                                                                                               id=jlrq type="text"
                                                                                               value="<?php echo ($acounts); ?>"></span>
                    ...
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable "
                            ...
                            <?php if(is_array($record)): $i = 0; $__LIST__ = $record;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td><a href="<?php echo U('Accounts/index?userid='.$vo['userid']);?>"
                                           style="color:blue;text-decoration:none;"><?php echo ($vo["userid"]); ?></a></td>
                                    <td><?php echo ($vo["regtime"]); ?></td>
                                    <td
                                    <?php if(($vo["online"]) == "1"): ?>style="color:#00ff7f;"
                                        <?php else: ?>
                                        style="color:#BDBDBD;"<?php endif; ?>
                                    ><?php echo ($vo["rname"]); ?>/<?php echo ($vo["rid"]); ?></td>
                                    <td>
                                        <?php if($vo["occupation"] == '0'): ?>龙胆
                                            ...
                                            斗仙<?php endif; ?>
                                        /&nbsp<?php echo ($vo["changelifecount"]); ?>重<?php echo ($vo["level"]); ?>级&nbsp/&nbsp<?php echo ($vo["combatforce"]); ?>

                                    </td>
                                    <td><?php echo ($vo["money2"]); ?></td>
                                    <td><?php echo ($zuan["money"]); ?></td>
                                    <td><?php echo ($vo["money1"]); ?></td>
                                    <td><?php echo ($vo["yinliang"]); ?></td>
                                    <td><?php if($vo["bhname"] == ''): ?>无帮人士
                                        <?php else: ?>
                                        <?php echo ($vo["bhname"]); endif; ?></td>
                                    <td><?php if($vo["bhname"] == ''and $vo["bhzhiwu"] == '0'): ?>无职务
                                        <else><?php elseif($vo["bhzhiwu"] == '0'): ?>
                                        帮众
                                        <?php elseif($vo["bhzhiwu"] == '1'): ?>
                                        帮主
                                        <?php elseif($vo["bhzhiwu"] == '2'): ?>
                                        副帮主
                                        <?php elseif($vo["bhzhiwu"] == '3'): ?>
                                        长老
                                        </else><?php endif; ?>
                                    </td>
                                    <td>map:<?php echo ($vo["position"]["0"]); ?> X:<?php echo ($vo["position"]["1"]); ?> Y:<?php echo ($vo["position"]["2"]); ?> Z:<?php echo ($vo["position"]["3"]); ?></td>
