...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">周流失</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            流失用户周趋势 （按上述“周流失”计算的每天数据组成的趋势
...
<script>
    ...
    function idselect() {
        ...
        location.href=www_url+"index.php?m=Home&c=TrendLoss&a=index&bclothes="+bclothes+"&eclothes="+eclothes+"&stime="+stime+"&creator="+creator;
    ...
    function exl(){
        ...
        location.href=www_url+"index.php?m=Home&c=TrendLoss&a=exl&bclothes="+bclothes+"&eclothes="+eclothes+"&stime="+stime+"&etime="+etime+"&creator="+creator;
    ...
    var line_title = ["周流失用户"]; //曲线名称
    var y_label = "数量"; //Y轴标题
    var x_label = "时间"; //X轴标题
    var x = ["上月本周","上周","本周"]; //定义X轴刻度值
    var title = "这是标题"; //统计图标标题
    j.jqplot.diagram.base("chart1", data, line_title, "周流失用户", x, x_label, y_label, data_max, 1);
    // 两分钟刷新
