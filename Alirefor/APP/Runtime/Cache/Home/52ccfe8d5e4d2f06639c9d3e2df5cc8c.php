            ...
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="dataTables_length" id="dataTables-example_length">
                            ...
                            id="start_time" value="<?php echo ($Stime); ?>">至
                            <input class="btn btn-default"
                            onclick="laydate({istime: true, format: 'YYYY-MM-DD'})"
                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive">
                        ...
                        <tr>
                                    <td>日期/礼包名称</td>
                                    <?php if(is_array($cgoods)): $i = 0; $__LIST__ = $cgoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><td><?php echo ($ko["cgoods"]); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
                        </tr>

                              <?php if(is_array($goodssale)): $i = 0; $__LIST__ = $goodssale;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($vo["0"]["LogTime"]); ?></td>
                                    <?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><td><?php echo ($v["num"]); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
