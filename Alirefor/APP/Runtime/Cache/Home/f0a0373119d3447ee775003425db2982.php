                    ...
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                                ...
                                <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($ko["money1s"]); ?></td>
                                        <td><?php echo ($ko["money2s"]); ?></td>
                                        <td><?php echo ($ko["money3s"]); ?></td>
                                        <td><?php echo ($ko["money4s"]); ?></td>
                                        <td><?php echo ($ko["money5s"]); ?></td>
                                        <td><?php echo ($ko["money6s"]); ?></td>
                                        <td><?php echo ($ko["money7s"]); ?></td>
                                        <td><?php echo ($ko["money30s"]); ?></td>
