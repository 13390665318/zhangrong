                ...
                <div class="row">
                    <div class="col-sm-6" style="width: 70%;">
                        <div class="dataTables_length" id="dataTables-example_length">
                            ...
                            <label>来源:
                                <div class="form-group input-group">
                                    <input class="form-control" id="resource" type="text" value="<?php echo ($currency_reason); ?>" placeholder="请输入来源">
                                </div>
                            </label>
                            <label>资源:
                                <div class="form-group input-group">
                                    <input class="form-control" id="resource2" type="text" value="<?php echo ($resource2); ?>" placeholder="请输入来源">
                                </div>
                            </label>
                            <label>方式</label>
                            <select style="margin-left: 0px; width: 10%;"  id="method"
                                    class="btn btn-default" autocomplete="off">
                                <option value="0" <?php if($value == '0'): ?>selected<?php endif; ?>>...请选择...</option>
                                <option value="1" <?php if($value == '1'): ?>selected<?php endif; ?>>产出</option>
                                <option value="-1" <?php if($value == '-1'): ?>selected<?php endif; ?>>消耗</option>
                            </select>
                    ...
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo ($ko["currency_reason"]); ?></td>
                                    <td><?php if($ko["value"] == 1): echo ($ko["currency_get"]["0"]["MoneyTypes"]); ?>
                                    <?php else: ?>
                                        <?php echo ($ko["currency_use"]["0"]["MoneyTypes"]); endif; ?></td>
                                    <td><?php if($ko["value"] == 1): ?><font color="green">产出</font>
                                        <td><font color="green"><?php echo ($ko["currency_get"]["0"]["count"]); ?></font></td>
                                        <?php else: ?><font color="red">消耗</font>
                                        <td><font color="red"><?php echo ($ko["currency_use"]["0"]["count"]); ?></font></td><?php endif; ?></td>
