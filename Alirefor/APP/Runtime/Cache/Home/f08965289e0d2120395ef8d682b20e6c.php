                        ...
                        <div class="dataTables_length" id="dataTables-example_length">
                            <label>帮派ID:
                                <div class="form-group input-group">
                                    <input class="form-control" id="union_id" type="text" value="<?php echo ($union_id); ?>" placeholder="帮派ID">
                                </div>
                            </label>
                            <label>帮派名称:
                                <div class="form-group input-group">
                                    <input class="form-control" id="union_name" type="text" value="<?php echo ($union_name); ?>" placeholder="帮派名称">
                                </div>
                            </label>
                    ...
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable "
                            ...
                            <?php if(is_array($guide)): $i = 0; $__LIST__ = $guide;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo ($ko["preunion_level"]); ?></td>
                                    <td><?php echo ($ko["laterunion_level"]); ?></td>
                                    <td><?php echo ($ko["build_type"]); ?></td>
