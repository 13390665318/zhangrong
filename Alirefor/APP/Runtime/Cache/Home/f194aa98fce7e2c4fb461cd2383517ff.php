                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <tbody id="ad">
                            <?php if(is_array($emaillog)): $i = 0; $__LIST__ = $emaillog;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($ko["LogTime"]); ?></td>
                                    <td><?php echo ($ko["role_id"]); ?></td>
                                    <td><?php echo ($ko["role_name"]); ?></td>
                                    <td><?php echo ($ko["account_id"]); ?></td>
                                  <!--  <td><?php echo ($ko["email_operation"]); ?></td>-->
                                    <td>
                                        <?php if($ko["email_operation"] == '0'): ?>查看
                                        <?php elseif($ko["email_operation"] == '1'): ?>
                                        提取附件
                                        <?php elseif($ko["email_operation"] == '2'): ?>
                                        删除邮件<?php endif; ?>
                                    </td>
                                    <td><?php echo ($ko["email_id"]); ?></td>
                                    <td><?php echo ($ko["email_get"]); ?></td>
...
<script type="text/javascript">
    ...
    function Cuselect(){
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href = "index.php?m=Home&c=Emaillog&a=index&start_time="+start_time+ "&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&db_id="+clothes;
        }
    ...
    function exl(){
        ...
        var game_user_name=$("#game_user_name").val();
        var goods_name=$("#type").val();
        location.href = "index.php?m=Home&c=Emaillog&a=exl&start_time="+start_time+ "&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&db_id="+clothes;
