...
<script>
    ...
    function idselect() {
        ...
        location.href=www_url+"index.php?m=Home&c=UserActivite&a=index&bclothes="+bclothes+"&eclothes="+eclothes+"&stime="+stime+"&etime="+etime+"&creator="+creator;
