                        ...
                        <div class="col-sm-12 table-responsive">
                            ...
                            <table class="table table-striped  table-bordered table-hover dataTable "
                                ...
                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($ko["currency_get"]["40"]); ?></td>
                                        <td><?php echo ($ko["currency_use"]["40"]); ?></td>
                                        <td><?php echo ($ko["currency_left"]["40"]); ?></td>
                                        <td><?php echo ($ko["currency_get"]["50"]); ?></td>
                                        <td><?php echo ($ko["currency_use"]["50"]); ?></td>
                                        <td><?php echo ($ko["currency_left"]["50"]); ?></td>
