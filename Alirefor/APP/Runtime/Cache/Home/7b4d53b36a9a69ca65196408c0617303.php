...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">留存用户</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            留存用户趋势（该指标特指：当天之前7天有登录过，今天也登录的用户） <div style="clear: both;"></div>
        </div>
...
<script>
    ...
    function idselect() {
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href=www_url+"index.php?m=Home&c=UserSave&a=index&db_id="+clothes+"&stime="+stime+"&etime="+etime;
        }
    ...
    function exl(){
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href=www_url+"index.php?m=Home&c=UserSave&a=exl&db_id="+clothes+"&stime="+stime+"&etime="+etime;
        }}
