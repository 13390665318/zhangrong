            ...
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive">
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            <thead>
                            <tr>
                                <td colspan="3"><font color="#ff4500">日期:<?php echo ($vo["date"]); ?> 平均时长:<?php echo ($vo["average"]); ?>s</font></td>
                            </tr>
                            <tr>
                            ...
                            <tbody id="ad">
                                <tr>
                                    ...
                                    <td><?php echo ($vo["num1s"]); ?>%</td>
                                </tr>
                            </tbody>
                            <tr>
                                <td>31~60</td>
                                <td><?php echo ($vo["num2"]); ?></td>
                                <td><?php echo ($vo["num2s"]); ?>%</td>
                            </tr>
                            <tr>
                                <td>60~120</td>
                                <td><?php echo ($vo["num3"]); ?></td>
                                <td><?php echo ($vo["num3s"]); ?>%</td>
                            </tr>
                            <tr>
                                <td>121~240</td>
                                <td><?php echo ($vo["num4"]); ?></td>
                                <td><?php echo ($vo["num4s"]); ?>%</td>
                            </tr>
                            <tr>
                                <td>241~360</td>
                                <td><?php echo ($vo["num5"]); ?></td>
                                <td><?php echo ($vo["num5s"]); ?>%</td>
                            </tr>
                            <tr>
                                <td>361~∞</td>
                                <td><?php echo ($vo["num6"]); ?></td>
                                <td><?php echo ($vo["num6s"]); ?>%</td>
                            </tr>
