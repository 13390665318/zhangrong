...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">回流用户</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            回流用户趋势（7天之前有登录，最近7天无登录，今天有登录的用户） <div style="clear: both;"></div>
        </div>
...
<script>
    ...
    function idselect() {
        ...
        location.href=www_url+"index.php?m=Home&c=UserBack&a=index&db_id="+clostu+"&stime="+stime+"&etime="+etime;
