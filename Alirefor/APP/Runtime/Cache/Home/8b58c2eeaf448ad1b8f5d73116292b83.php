...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">副本活动/参与率</h1>
        </div>
    </div>
    ...
    <?php if(is_array($clostu)): $i = 0; $__LIST__ = $clostu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["db_id"]) == $db_id): ?><option value="<?php echo ($vo["db_id"]); ?>" selected="selected"><?php echo ($vo["clothes"]); ?></option>
            ...
            <option value="<?php echo ($vo["db_id"]); ?>"><?php echo ($vo["clothes"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                             ...
                                             id="start_time" value="<?php echo ($Stime); ?>" onclick="Cuselect">
                ...
                <hr>
                <a href="<?php echo U('Fubencon/add');?>"><button class="btn btn-primary" id="search-operator-btn" type="submit"  >添加副本</button></a>
                <div class="row">
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable "
                            ...
                            <tbody id="ad">
                            <?php if(is_array($fubencon)): $i = 0; $__LIST__ = $fubencon;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($vo["korea_name"]); ?></td>
                                    <td><?php echo ($vo["joinnum"]); ?></td>
                                    <td><?php echo ($vo["joinnum"]); ?>/<?php echo ($num); ?></td>
...
<script>
    function exl() {
        ...
        location.href = url + "index.php?m=Home&c=Fubencon&a=exl&value=" + value + "&db_id=" + clothes + "&start_time=" + start_time + "&end_time=" + end_time + "&game_user_id=" + game_user_id + "&game_user_name=" + game_user_name + "&goods_name=" + goods_name;
...
<script>
    function Cuselect() {
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href = "index.php?m=Home&c=Fubencon&a=index&start_time="+start_time+ "&end_time="+end_time+"&db_id="+clothes+"&game_user_name="+game_user_name;
        }
    }
