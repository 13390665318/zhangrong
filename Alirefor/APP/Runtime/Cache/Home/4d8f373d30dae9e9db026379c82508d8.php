...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">登出日志</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            登出 <div style="clear: both;"></div>
        </div>
        <!-- /.panel-heading -->
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="dataTables_length" id="dataTables-example_length">
                            ...
                            </select><label>&nbsp&nbsp&nbsp<input class="btn btn-default"
                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <tbody id="ad">
                            <?php if(is_array($logoutlog)): $i = 0; $__LIST__ = $logoutlog;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($ko["logout_time"]); ?></td>
                                    ...
                                    <td><?php echo ($ko["Online_time"]); ?></td>
                                    <td>角色好友数:<?php echo ($ko["player_message"]["FriendCount"]); ?>  经验值:<?php echo ($ko["player_message"]["CurExp"]); ?>
                                      战力:<?php echo ($ko["player_message"]["CombatForce"]); ?> PK值:<?php echo ($ko["player_message"]["PKPoint"]); ?> 帮贡:<?php echo ($ko["player_message"]["BangGong"]); ?></td>
...
<script>
    function exl(){
        ...
        location.href="index.php?m=Home&c=Logout&a=exl&start_time="+start_time+ "&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&db_id="+clothes;
    }
</script>
...
<script>
    function Cuselect() {
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href = "index.php?m=Home&c=Logout&a=index&start_time="+start_time+ "&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&db_id="+clothes;
        }
    }
