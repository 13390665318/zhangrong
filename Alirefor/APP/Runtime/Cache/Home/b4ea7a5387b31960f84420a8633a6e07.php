...
var tmptxt=$(this).val();       
    ...
    function idselect() {
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href = "index.php?m=Home&c=NewCount&a=index&stime="+stime+ "&etime="+etime+"&db_id="+clothes;
        }
    }
 function exl(){
     var clothes=$("#clothes").val();
     ...
     location.href=www_url+"index.php?m=Home&c=NewCount&a=exl&clothes="+clothes+"&stime="+stime+"&etime="+etime+"&creator="+creator;
