        ...
        <div class="gzsysq">
            <div class="bt_con">
                <ul class="nav nav-tabs">
                    <li onclick="money_type(-1)" data-id="-1"><a>道具消耗</a></li>
                    <li onclick="money_type(1)" data-id="1"><a>道具产出</a></li>
                </ul>
            </div>
        </div>
        <!-- /.panel-heading -->
...
<script type="text/javascript">
    ...
    function Cuselect(){
       ...
       location.href=url+"index.php?m=Home&c=Prop&a=index&value="+value+"&db_id="+clothes+"&start_time="+start_time+"&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&goods_name="+goods_name;
