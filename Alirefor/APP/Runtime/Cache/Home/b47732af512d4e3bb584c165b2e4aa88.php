...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">流失漏斗</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            流失趋势 （上一个N日内有登录，在最近N日无登录）<div style="clear: both;"></div>
        </div>
...
<script>
    ...
    function idselect() {
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href=www_url+"index.php?m=Home&c=UserLoss&a=index&db_id="+clothes+"&stime="+stime+"&etime="+etime+"&creator="+creator+"&type="+type;
        }
    ...
    function exl() {
        ...
        if (clothes == "...选择游戏服务器...") {
            ...
            location.href = www_url + "index.php?m=Home&c=UserLoss&a=exl&db_id=" + clothes + "&stime=" + stime + "&etime=" + etime + "&creator=" + creator + "&type=" + type;
        }
    }
