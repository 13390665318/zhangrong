                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable "
                            ...
                            <tbody id="ad">
                            <?php if(is_array($fashion)): $i = 0; $__LIST__ = $fashion;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($ko["LogTime"]); ?></td>
                                    <td><?php echo ($ko["role_id"]); ?></td>
                                    <td><?php echo ($ko["role_name"]); ?></td>
                                    <td><?php echo ($ko["fashion_id"]); ?></td>
                                    <td><?php echo ($ko["fashion_name"]); ?></td>
                                    <td><?php echo ($ko["fashion_operation"]); ?></td>
                                    <td><?php echo ($ko["preequip"]); ?></td>
                                    <td><?php echo ($ko["item_use"]); ?></td>
                                    <td><?php echo ($ko["item_left"]); ?></td>
...
<script>
    function Cuselect() {
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href = "index.php?m=Home&c=Fashion&a=index&start_time="+start_time+ "&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&db_id="+clothes;
        }
    }
    function exl(){
        var clothes=$("#clothes").val();
        ...
        var game_user_id = $("#game_user_id").val();
        var game_user_name = $("#game_user_name").val();
            location.href="index.php?m=Home&c=Fashion&a=exl&start_time="+start_time+ "&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&db_id="+clothes;
    }
