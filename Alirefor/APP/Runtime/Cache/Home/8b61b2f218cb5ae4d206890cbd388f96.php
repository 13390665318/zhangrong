                ...
                <div class="row">
                    <div class="col-sm-6" style="width: 70%;">
                        <div class="dataTables_length" id="dataTables-example_length">
                            ...
                            <label>显示升级日志
                                <div class="form-group input-group">
                                    <input type="checkbox" id="level" name="test" <?php echo ($check); ?> value="1" style="width: 30px;height: 20px;"  />
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <?php if(is_array($roleexp)): $i = 0; $__LIST__ = $roleexp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo ($ko["prerole_ChangeLife"]); ?>重<?php echo ($ko["prerole_level"]); ?>级</td>
                                    <td><?php echo ($ko["laterrole_ChangeLife"]); ?>重<?php echo ($ko["laterrole_level"]); ?>级</td>
    ...
    function Cuselect() {
       ...
       if( $("input[type='checkbox']").is(':checked')){
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href = "index.php?m=Home&c=Roleexp&a=index&start_time="+start_time+ "&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&db_id="+clothes+"&level="+level;
        }
    }
    function exl() {
        var clothes=$("#clothes").val();
        ...
        location.href = "index.php?m=Home&c=Roleexp&a=exl&start_time="+start_time+ "&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&db_id="+clothes+"&level="+level;
