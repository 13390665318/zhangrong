...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">等级消耗钻石占比</h1>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 table-responsive">
                            ...
                            <table class="table table-striped  table-bordered table-hover dataTable "
                                ...
                                <tbody id="ad">
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><tr>
                                        <td><?php echo ($ko["role_ChangeLife"]); ?>重<?php echo ($ko["level"]); ?>级</td>
                                        <td><?php echo ($ko["zuangetnum"]); ?></td>
                                        <td><?php echo ($ko["zuanusenum"]); ?></td>
                                        <td><?php echo ($ko["than"]); ?>%</td>
...
<script>
    function Cuselect() {
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href = "index.php?m=Home&c=Zuan&a=index2&start_time="+start_time+ "&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&db_id="+clothes;
        }
    }
