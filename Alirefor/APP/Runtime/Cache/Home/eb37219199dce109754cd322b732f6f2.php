...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">宝藏抽奖日志</h1>
        </div>
    </div>
                    ...
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable "
                            ...
                            <tr>
                                ...
                                <td>宝箱类型</td>
                                <td>抽奖获得</td>
                                <td width="8%"> 钻石、代券消耗</td>
                                <td width="8%">钻石、代券剩余</td>
                            </tr>
                            </thead>
                            <tbody id="ad">
                            <?php if(is_array($loglog)): $i = 0; $__LIST__ = $loglog;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo ($ko["treasure_type"]); ?></td>
                                    <td><?php echo ($ko["treasure_get"]); ?></td>
                                    <td><?php echo ($ko["diamond_use"]); ?></td>
                                    <td><?php echo ($ko["diamond_left"]); ?></td>
...
<script>
    function exl() {
        ...
        location.href = "index.php?m=Home&c=Checkpoints&a=exl&start_time="+start_time+ "&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&db_id="+clothes;
...
<script>
    function Cuselect() {
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href = "index.php?m=Home&c=Checkpoints&a=index&start_time="+start_time+ "&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&db_id="+clothes;
        }
    }
