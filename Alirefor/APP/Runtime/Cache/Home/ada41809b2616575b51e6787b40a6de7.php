...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">周活趋势</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            活跃用户周趋势（从当天开始往前算，7天内有登录的用户为周活跃） <div style="clear: both;"></div>
        </div>
...
<script>
    ...
    function idselect() {
        ...
        location.href=www_url+"index.php?m=Home&c=TrendActivity&a=index2&bclothes="+bclothes+"&eclothes="+eclothes+"&stime="+stime+"&creator="+creator;
