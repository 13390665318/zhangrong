                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="dataTables_length" id="dataTables-example_length">
                            ...
                            </select>&nbsp&nbsp&nbsp<input class="btn btn-default"
                    ...
                    <div class="row">
                        <div class="col-sm-12 table-responsive">
                            <table class="table table-striped  table-bordered table-hover dataTable "
                                ...
                                <tbody id="ad">
                                <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($k % 2 );++$k;?><tr>
                                        <td><?php echo ($k); ?></td>
                                        <td><?php echo ($ko["game_user_name"]); ?></td>
                                        <td><?php echo ($ko["game_user_id"]); ?></td>
                                        <td><?php echo ($ko["total"]); ?></td>
...
<script>
    function Cuselect() {
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href = "index.php?m=Home&c=Zuan&a=index3&start_time="+start_time+ "&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&db_id="+clothes;
        }
    }
