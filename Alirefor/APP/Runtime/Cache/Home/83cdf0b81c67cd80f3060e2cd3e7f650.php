...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">双周流失</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            流失用户双周趋势 <div style="clear: both;"></div>
        </div>
...
<script>
    ...
    function idselect() {
        ...
        location.href=www_url+"index.php?m=Home&c=TrendLoss&a=index2&bclothes="+bclothes+"&eclothes="+eclothes+"&stime="+stime+"&creator="+creator;
    ...
    var line_title = ["双周流失用户"]; //曲线名称
    var y_label = "数量"; //Y轴标题
    var x_label = "时间"; //X轴标题
    var x = ["上月双周","上双周","本双周"]; //定义X轴刻度值
    var title = "这是标题"; //统计图标标题
    j.jqplot.diagram.base("chart1", data, line_title, "双周流失用户", x, x_label, y_label, data_max, 1);
    // 两分钟刷新
