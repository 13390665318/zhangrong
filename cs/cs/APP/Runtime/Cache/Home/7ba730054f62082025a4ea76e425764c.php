                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <tbody id="ad">
                            <tr>
                                <td><?php echo ($wings["rname"]); ?></td>
                                <td>
                                    <?php if($wings["occupation"] == '0'): ?>龙胆
                                        <?php elseif($wings["occupation"] == '1'): ?>
                                        花灵
                                        <?php elseif($wings["occupation"] == '2'): ?>
                                        巧工
                                        <?php elseif($wings["occupation"] == '4'): ?>
                                        斗仙<?php endif; ?>
                                </td>
                                <td><?php echo ($wings["wingid"]); ?></td>
                                <td><?php echo ($wings["forgelevel"]); ?></td>
                                <td><?php echo ($wings["starexp"]); ?></td>
                                <td><?php echo ($wings["failednum"]); ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
