                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <tbody id="ad">
                            <tr>
                                <td><?php echo ($star["rid"]); ?></td>
                                <td><?php echo ($star["v32"]); ?></td>
                            </tr>
                            </tbody>
                        </table>
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <tbody id="ad">
                            <?php if(is_array($stars)): $i = 0; $__LIST__ = $stars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$stars): $mod = ($i % 2 );++$i;?><tr>
                                <td>
                                    <?php if($stars["starsiteid"] == '1'): ?>孤煌
                                        <?php elseif($stars["starsiteid"] == '2'): ?>
                                        逐波
                                        <?php elseif($stars["starsiteid"] == '3'): ?>
                                        祝雨
                                        <?php elseif($stars["starsiteid"] == '4'): ?>
                                        咏梦
                                        <?php elseif($stars["starsiteid"] == '5'): ?>
                                        双炽
                                        <?php elseif($stars["starsiteid"] == '6'): ?>
                                        破军
                                        <?php elseif($stars["starsiteid"] == '7'): ?>
                                        天机
                                        <?php elseif($stars["starsiteid"] == '8'): ?>
                                        启明
                                        <?php elseif($stars["starsiteid"] == '9'): ?>
                                        纷焱
                                        <?php elseif($stars["starsiteid"] == '10'): ?>
                                        密深
                                        <?php elseif($stars["starsiteid"] == '11'): ?>
                                        暴岚
                                        <?php elseif($stars["starsiteid"] == '12'): ?>
                                        心战<?php endif; ?>
                                </td>
                                <td><?php echo ($stars["starslotid"]); ?></td>
...
<script>
    ...
    function Cuselect(){
        ...
        location.href="index.php?m=Home&c=Star&a=index&value="+value+"&db_id="+clothes+"&start_time="+start_time+"&end_time="+end_time+"&roleid="+roleid+"&game_user_name="+game_user_name+"&goods_name="+goods_name;
    }
    function role(){
        var roleid=$("#rid").val();
