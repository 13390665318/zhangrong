...
<div id="page-wrapper">
	...
	<li>
     ...
     <!--   <div class="canvas2">
        ...
        <div class="container"><button class="btn btn-primary btn2" type="button" style="position:relative;margin:0 auto;display:block;width:100px;text-align: center">展开</button></div>
-->
    </div>
    <script>
        function online(){
        ...
        //  var a=<?php echo ($Stime); ?>;
        var maxN2 = eval("Math.max(" + stu2.toString() + ")")+10000;
        stu2=stu2.reverse();
        var data2 = [stu2];
...
console.log(obj3 );
        var maxN2 = eval("Math.max(" + stu3.toString() + ")")+5000;
      //  stu3=stu3.reverse();
     //   rus3=rus3.reverse();
...
// 充值人数
        ...
        //  var a=<?php echo ($Stime); ?>;
        var maxN4 = eval("Math.max(" + stu4.toString() + ")")+1000;
        stu4=stu4.reverse();
        var data4 = [stu4];
        ...
        //  var a=<?php echo ($Stime); ?>;
        var maxN5 = eval("Math.max(" + stu5.toString() + ")")+10000;
        stu5=stu5.reverse();
        var data5 = [stu5];
