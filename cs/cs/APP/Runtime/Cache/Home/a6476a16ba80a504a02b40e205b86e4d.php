...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">平均在线人数</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            平均在线人数趋势 <div style="clear: both;"></div>
        </div>
...
<script>
    ...
    function idselect() {
        ...
        location.href=www_url+"index.php?m=Home&c=ACU&a=index&db_id="+clothes+"&stime="+stime+"&etime="+etime;
    ...
    function exl(){
        ...
        location.href=www_url+"index.php?m=Home&c=ACU&a=exl&db_id="+clothes+"&stime="+stime+"&etime="+etime;
    ...
    var line_title = ["用户平局在线人数","B"]; //曲线名称
    var y_label = "数量"; //Y轴标题
    var x_label = "时间"; //X轴标题
    var x = [<?php echo ($Stime); ?>]; //定义X轴刻度值
    var title = "这是标题"; //统计图标标题
    j.jqplot.diagram.base("chart1", data, line_title, "用户平局在线人数", x, x_label, y_label, data_max, 1);
