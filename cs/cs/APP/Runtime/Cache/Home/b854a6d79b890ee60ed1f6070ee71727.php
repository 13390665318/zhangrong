...
<div id="page-wrapper">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            礼包邀请码 <div style="clear: both;"></div>
        </div>
        <a href="<?php echo U('Invitation/add');?>">  <button type="button" class="btn btn-primary btn_css">添加</button></a>
        <button type="button" class="btn btn-default btn_css" onclick="edit()">修改</button>
        <button type="button" class="btn btn-default btn_css" onclick="show()">查看</button>
        <a href="<?php echo U('Invitation/find');?>">  <button type="button" class="btn btn-primary btn_css">查找</button></a>
        <!-- /.panel-heading -->
                    ...
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td><input type="checkbox" name="num" id="" value="<?php echo ($vo["code_type_id"]); ?>" /></td>
                                    <td><?php echo ($vo["code_type_id"]); ?></td>
                                    <td><?php echo ($vo["code_type_name"]); ?></td>
                                    <td><?php echo ($vo["goods_ids"]); ?></td>


                                    <td><?php if($vo["type"] == 1): ?>通用<?php else: ?>唯一<?php endif; ?></td>
...
<script>
    ...
    function edit(){
        ...
        if(ids==""){
            ...
            location.href=url+"index.php?m=Home&c=Invitation&a=edit&id="+ids;
    ...
    function show() {
        ...
        if(ids==""){
            ...
            location.href=url+"index.php?m=Home&c=Invitation&a=show&id="+ids;
