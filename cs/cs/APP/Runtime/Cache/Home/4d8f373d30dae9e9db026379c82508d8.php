                    ...
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <?php if(is_array($logoutlog)): $i = 0; $__LIST__ = $logoutlog;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo ($ko["role_ChangeLife"]); ?></td>
                                    <td><?php echo ($ko["role_level"]); ?></td>
                                    ...
                                    <td><?php echo ($ko["player_message"]); ?></td>
...
<script>
    function Cuselect() {
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href = "index.php?m=Home&c=Logout&a=index&start_time="+start_time+ "&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name;
        }
    }
