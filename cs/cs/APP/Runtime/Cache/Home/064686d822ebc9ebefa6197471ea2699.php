...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">首付金额分布</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            首付金额分布（按付费金额划分维度，统计人数和占比） <div style="clear: both;"></div>
        </div>
 ...
 <td>(<?php echo ($ko["day8"]); ?>)|<?php echo ($ko["day8s"]); ?>%</td>
 <td>(<?php echo ($ko["day9"]); ?>)|<?php echo ($ko["day9s"]); ?>%</td>
...
<script>
    ...
    function idselect() {
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href=www_url+"index.php?m=Home&c=FirstPay&a=index2&db_id="+clothes+"&stime="+stime+"&etime="+etime;
        }
    ...
    function exl(){
        ...
        if(clothes=="...选择游戏服务器..."){
            ...
            location.href=www_url+"index.php?m=Home&c=UserSave&a=exl&db_id="+clothes+"&stime="+stime+"&etime="+etime+"&creator="+creator+"&type="+type;
        }}
