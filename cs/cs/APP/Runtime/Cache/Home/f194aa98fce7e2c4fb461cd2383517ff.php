                        ...
                        <div class="dataTables_length" id="dataTables-example_length">
                            <label>物品编号:
                                <div class="form-group input-group">
                                    <input class="form-control" id="type" type="text" placeholder="道具名称">
                                </div>
                            </label>
                            <label>玩家ID:
                                <div class="form-group input-group">
...
<script type="text/javascript">
    ...
    function Cuselect(){
        ...
        location.href="index.php?m=Home&c=Prop&a=index&value="+value+"&db_id="+clothes+"&start_time="+start_time+"&end_time="+end_time+"&game_user_id="+game_user_id+"&game_user_name="+game_user_name+"&goods_name="+goods_name;
