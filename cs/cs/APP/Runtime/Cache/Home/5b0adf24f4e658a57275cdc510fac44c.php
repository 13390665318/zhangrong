...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">装备</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            装备信息 <div style="clear: both;"></div>
        </div>
...
<script>
    ...
    function Cuselect(){
        ...
        location.href="index.php?m=Home&c=Equipment&a=index&value="+value+"&db_id="+clothes+"&start_time="+start_time+"&end_time="+end_time+"&roleid="+roleid+"&game_user_name="+game_user_name+"&goods_name="+goods_name;
    }
    function role(){
        var roleid=$("#rid").val();
