...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">荣耀</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            荣耀信息 <div style="clear: both;"></div>
        </div>
                    ...
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <tr>
                                ...
                                <td> <?php if($cheng["v36"] == '0'): ?>无
                                    <?php elseif($cheng["v36"] == '1'): ?>
                                    猛士
                                    <?php elseif($cheng["v36"] == '2'): ?>
                                    战狂
                                    <?php elseif($cheng["v36"] == '3'): ?>
                                    无双
                                    <?php elseif($cheng["v36"] == '4'): ?>
                                    救星
                                    <?php elseif($cheng["v36"] == '5'): ?>
                                    神勇
                                    <?php elseif($cheng["v36"] == '6'): ?>
                                    力王
                                    <?php elseif($cheng["v36"] == '7'): ?>
                                    显圣
                                    <?php elseif($cheng["v36"] == '8'): ?>
                                    魔霸
                                    <?php elseif($cheng["v36"] == '9'): ?>
                                    大圣
                                    <?php elseif($cheng["v36"] == '10'): ?>
                                    真人
                                    <?php elseif($cheng["v36"] == '11'): ?>
                                    龙主
                                    <?php elseif($cheng["v36"] == '12'): ?>
                                    圣天<?php endif; ?>
                                </td>
                                <td>
                                    <?php if($glory["v7"] == '0'): ?>无
                                        <?php elseif($glory["v7"] == '1'): ?>
                                        兵士
                                        <?php elseif($glory["v7"] == '2'): ?>
                                        精兵
                                        <?php elseif($glory["v7"] == '3'): ?>
                                        队官
                                        <?php elseif($glory["v7"] == '4'): ?>
                                        营带
                                        <?php elseif($glory["v7"] == '5'): ?>
                                        管带
                                        <?php elseif($glory["v7"] == '6'): ?>
                                        都卫
                                        <?php elseif($glory["v7"] == '7'): ?>
                                        都统
                                        <?php elseif($glory["v7"] == '8'): ?>
                                        提辖
                                        <?php elseif($glory["v7"] == '9'): ?>
                                        团练
                                        <?php elseif($glory["v7"] == '10'): ?>
                                        总兵
                                        <?php elseif($glory["v7"] == '11'): ?>
                                        提督
                                        <?php elseif($glory["v7"] == '12'): ?>
                                        大将军<?php endif; ?>
                                    </td>
                            </tr>
                            </tbody>
...
<script>
    ...
    function Cuselect(){
        ...
        location.href="index.php?m=Home&c=Glory&a=index&value="+value+"&db_id="+clothes+"&start_time="+start_time+"&end_time="+end_time+"&roleid="+roleid+"&game_user_name="+game_user_name+"&goods_name="+goods_name;
    }
    function role(){
        var roleid=$("#rid").val();
