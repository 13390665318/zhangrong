...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">宠物</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            宠物信息 <div style="clear: both;"></div>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <tbody id="ad">
                            <?php if(is_array($pet)): $i = 0; $__LIST__ = $pet;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
...
<script>
    ...
    function Cuselect(){
        ...
        location.href="index.php?m=Home&c=Pet&a=index&value="+value+"&db_id="+clothes+"&start_time="+start_time+"&end_time="+end_time+"&roleid="+roleid+"&game_user_name="+game_user_name+"&goods_name="+goods_name;
    }
    function role(){
        var roleid=$("#rid").val();
