...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">技能</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            技能信息 <div style="clear: both;"></div>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="dataTables_length" id="dataTables-example_length">
                            ...
                            <div><button class="btn btn-default" id="rid" onclick="role()" value="<?php echo ($skills["0"]["rid"]); ?>">角色首页</button></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <tbody id="ad">
                            <?php if(is_array($skills)): $i = 0; $__LIST__ = $skills;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($vo["skillid"]); ?></td>
                                <td><?php echo ($vo["skilllevel"]); ?></td>
                                <td><?php echo ($vo["usednum"]); ?></td>
...
<script>
    ...
    function Cuselect(){
        ...
        location.href="index.php?m=Home&c=Skills&a=index&value="+value+"&db_id="+clothes+"&start_time="+start_time+"&end_time="+end_time+"&roleid="+roleid+"&game_user_name="+game_user_name+"&goods_name="+goods_name;
    }
    function role(){
        var roleid=$("#rid").val();
