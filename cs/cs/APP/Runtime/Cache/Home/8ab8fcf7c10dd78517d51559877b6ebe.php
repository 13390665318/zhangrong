...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">背包</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            背包信息 <div style="clear: both;"></div>
        </div>
        ...
        <div class="panel-body" id="lists">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                    <div class="col-sm-6">
                        <v class="dataTables_length" id="dataTables-example_length">
                            ...
                            <div><button class="btn btn-default" id="rid" onclick="role()" value="<?php echo ($roleid); ?>">角色首页</button> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp备注:<font color="#63B8FF">蓝色</font>为绑定，<font color="#BDBDBD">灰色</font>为未绑定</div>
                            <span id="jianli">&nbsp账号ID&nbsp&nbsp<input class="form-control" disabled="disabled" size="8"  id=jlrq type="text"value="<?php echo ($equip["0"]["rid"]); ?>" ></span>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12 table-responsive">
                    ...
                    <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                        ...
                        <tbody id="ad">
                        <?php if(is_array($equip)): $i = 0; $__LIST__ = $equip;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td <?php if(($vo["binding"]) == "1"): ?>style="color:#63B8FF;"
                                <?php else: ?>
                                style="color:#BDBDBD;"<?php endif; ?>width="20%"><?php echo ($vo["Title"]); ?></td>
                                <td width="20%"><?php echo ($vo["goodsid"]); ?></td>
                                <td width="20%"><?php echo ($vo["forge_level"]); ?></td>
                                <td width="20%"><?php echo ($vo["gcount"]); ?></td>
...
<script>
    ...
    function Cuselect(){
        ...
        location.href="index.php?m=Home&c=Backpack&a=index&value="+value+"&db_id="+clothes+"&start_time="+start_time+"&end_time="+end_time+"&roleid="+roleid+"&game_user_name="+game_user_name+"&goods_name="+goods_name;
    }
    function role(){
        var roleid=$("#rid").val();
