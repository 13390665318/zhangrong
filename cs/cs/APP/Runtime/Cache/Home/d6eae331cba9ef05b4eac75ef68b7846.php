...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">时装</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            时装信息 <div style="clear: both;"></div>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="dataTables_length" id="dataTables-example_length">
                            ...
                            <div><button class="btn btn-default" id="rid" onclick="role()" value="<?php echo ($wings["rid"]); ?>">角色首页</button></div>
...
<script>
    ...
    function Cuselect(){
        ...
        location.href="index.php?m=Home&c=Role&a=index&value="+value+"&db_id="+clothes+"&start_time="+start_time+"&end_time="+end_time+"&roleid="+roleid+"&game_user_name="+game_user_name+"&goods_name="+goods_name;
    }
    function role(){
        var roleid=$("#rid").val();
