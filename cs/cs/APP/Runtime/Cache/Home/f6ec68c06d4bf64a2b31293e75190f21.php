...
<div id="page-wrapper">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            权限列表 <div style="clear: both;"></div>
        </div>
        <a href="<?php echo U('Auth/add');?>">  <button type="button" class="btn btn-primary btn_css">添加</button></a>
                    ...
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td width="10%"><?php echo ($vo["id"]); ?></td>
                                    <td><?php echo ($vo["name"]); ?></td>
                                    <td><textarea cols="100" role="40"><?php echo ($vo["auth_name"]); ?></textarea></td>
                                    <td><a href="<?php echo U('Auth/edit',array('id'=>$vo['id']));?>"><input type="button" value="编辑"></a>
                                        &nbsp;<a href="<?php echo U('Auth/del',array('id'=>$vo['id']));?>"><input type="button" value="删除"></a>
                                    </td>
