...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">月活趋势</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            活跃用户月趋势 （从当天开始往前算，30天内有登录的用户为周活跃）<div style="clear: both;"></div>
        </div>
...
<script>
    ...
    function idselect() {
        ...
        location.href=www_url+"index.php?m=Home&c=TrendActivity&a=index3&bclothes="+bclothes+"&eclothes="+eclothes+"&stime="+stime+"&creator="+creator;
    ...
    var line_title = ["月活跃用户"]; //曲线名称
    var y_label = "数量"; //Y轴标题
    var x_label = "时间"; //X轴标题
    var x = ["去年本月","上月","本月"]; //定义X轴刻度值
    var title = "这是标题"; //统计图标标题
    j.jqplot.diagram.base("chart1", data, line_title, "月活跃用户", x, x_label, y_label, data_max, 1);
    // 两分钟刷新
