...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">公会信息</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            公会信息 <div style="clear: both;"></div>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="dataTables_length" id="dataTables-example_length">
                            ...
                            </select>&nbsp&nbsp<input class="btn btn-default" name="date" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" id="start_time" value="<?php echo ($stime); ?>">
 ...
 <td><?php echo ($vo["account"]); ?></td>
                                    ...
                                    <td>
                                        <?php if($vo["isgag"] == 1): ?><span style="color: tomato">已禁言</span>
                                        <?php else: ?>
                                        <span style="color: #00a0e9">未禁言</span><?php endif; ?>
                                        &nbsp;
                                        <?php if($vo["isblock"] == 1): ?><span style="color: tomato">已封号</span>
                                            <?php else: ?>
                                            <span style="color: #00a0e9">未封号</span><?php endif; ?>
