...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">关卡流失统计</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            关卡流失统计 <div style="clear: both;"></div>
        </div>
                ...
                <div class="row" style="width: 100%">
                    <div class="col-sm-6" style="width: 100%">
                        <div class="dataTables_length" id="dataTables-example_length" style="width: 100%">
                            ...
                            到<input onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" id="etime" value="<?php echo ($etime); ?>">
                            <label>流失标准:
