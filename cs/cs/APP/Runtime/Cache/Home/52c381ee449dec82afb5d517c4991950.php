...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">支付账号</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            支付账号趋势 <div style="clear: both;"></div>
        </div>
...
<script>
    ...
    function idselect() {
     ...
     //   var creator=$("#maxOption2").val();
        ...
        location.href=www_url+"index.php?m=Home&c=PayMoney&a=index&bclothes="+bclothes+"&eclothes="+eclothes+"&stime="+stime+"&etime="+etime;
    ...
    var maxN = eval("Math.max(" + stu.toString() + ")")+500;
    stu=stu.reverse();
    var data = [stu];
    var data_max = maxN; //Y轴最大刻度
    var line_title = ["支付账号","B"]; //曲线名称
    var y_label = "数量"; //Y轴标题
    var x_label = "时间"; //X轴标题
    var x = [<?php echo ($Stime); ?>]; //定义X轴刻度值
    var title = "这是标题"; //统计图标标题
    j.jqplot.diagram.base("chart1", data, line_title, "支付账号", x, x_label, y_label, data_max, 1);
    // 两分钟刷新
