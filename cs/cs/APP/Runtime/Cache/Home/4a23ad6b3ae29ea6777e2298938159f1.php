                    ...
                    <div class="col-sm-6" style="width: 70%;">
                        <div class="dataTables_length" id="dataTables-example_length">
                            <span><label>物品编号:</label>
                                    <input class="form-control" id="type" type="text" placeholder="道具名称" size="10px">
                                &nbsp&nbsp
                                  <label>玩家ID:</label>
                                    <input class="form-control" id="game_user_id" type="text" placeholder="玩家ID" size="10px">
                                &nbsp&nbsp
                            <label>角色名称:</label>
                                    <input class="form-control" id="game_user_name" type="text" placeholder="角色名称" size="10px">
                                &nbsp&nbsp
                             <label>原因:</label>
                                    <input class="form-control" id="cause" type="text" placeholder="原因" size="10px">
                                &nbsp&nbsp
                    ...
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <?php if(is_array($Log)): $i = 0; $__LIST__ = $Log;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ko): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo ($ko["prop"]); ?></td>
                                    <td ><?php if(($ko["change_type"]) == "0"): ?><font color="red">消耗<?php echo ($ko["use_num"]); ?>个</font></td>
                                   <?php else: ?><font color="green">获得<?php echo ($ko["get_num"]); ?>个</font></td><?php endif; ?>
                                    <td><?php echo ($ko["left_num"]); ?></td>
