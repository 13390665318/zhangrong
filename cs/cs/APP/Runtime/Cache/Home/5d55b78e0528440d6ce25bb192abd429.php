...
<div id="page-wrapper">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            登录账号趋势（从今天0点到当前时间，总登录帐号数量） <div style="clear: both;"></div>
        </div>
        ...
        从<input class="btn btn-default" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" id="stime" value="<?php echo ($stime); ?>">
        ...
        <div class="col-lg-10" style="width: 11%">
            <div class="form-group">
                <select id="maxOption2" class="selectpicker show-menu-arrow form-control" multiple >
                    <?php if(is_array($qudao)): $i = 0; $__LIST__ = $qudao;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cid"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
...
var tmptxt=$(this).val();       
	...
	return false;
        ...
        location.href=www_url+"index.php?m=Home&c=UserLogin&a=index&bclothes="+bclothes+"&eclothes="+eclothes+"&stime="+stime+"&etime="+etime+"&creator="+creator;
    ...
    function exl(){
        ...
        location.href=www_url+"index.php?m=Home&c=UserLogin&a=exl&bclothes="+bclothes+"&eclothes="+eclothes+"&stime="+stime+"&etime="+etime+"&creator="+creator;
    ...
    j.jqplot.diagram.base("chart1", data, line_title, "登录用户", x, x_label, y_label, data_max, 1);
    // 两分钟刷新
