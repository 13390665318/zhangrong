...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">邮箱</h1>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            邮箱 <div style="clear: both;"></div>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="dataTables_length" id="dataTables-example_length">
                            ...
                            <button class="btn btn-default" id="search-operator-btn" type="submit"  onclick="Cuselect()"><i class="fa fa-search"></i>搜索</button><br><br>
                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive">
                        ...
                        <table class="table table-striped  table-bordered table-hover dataTable " id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;" width="100%">
                            ...
                            <tbody id="ad">
                            <?php if(is_array($emaill)): $i = 0; $__LIST__ = $emaill;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($vo["mailid"]); ?></td>
                                    <td><?php echo ($vo["receiverrid"]); ?></td>
                                    <td><?php echo ($vo["reveiverrname"]); ?></td>
                                    <td><?php echo ($vo["readtime"]); ?></td>
                                    <td><?php if(($vo["isread"]) == "1"): ?>已读
                                    <?php else: ?>未读<?php endif; ?></td>
                                    <td><?php if(($vo["hasfetchattachment"]) == "1"): ?>已提取附件
                                    <?php else: ?>未提取<?php endif; ?></td>
...
<script>
    function Cuselect(){
        ...
        location.href="index.php?m=Home&c=Emaill&a=index&value="+value+"&db_id="+clothes+"&start_time="+start_time+"&end_time="+end_time+"&roleid="+roleid+"&game_user_name="+game_user_name+"&goods_name="+goods_name;
    }
    function role(){
        var roleid=$("#rid").val();
    ...
    function choice(a) {
        ...
        if(num==1){
            ...
            if(clothes=="...选择游戏服务器..."){
                ...
                location.href=url+"index.php?m=Home&c=Playtable&a=index&db_id="+clothes;
            }
        }else{
            var start_time=$("#start_time").val()
            var end_time=$("#end_time").val()
            ...
            if(clothes=="...选择游戏服务器..."){
                ...
                location.href=url+"index.php?m=Home&c=Playtable&a=index&db_id="+clothes+"&start_time="+start_time+"&end_time="+end_time+"&game_user_name="+game_user_name+"&game_user_id="+game_user_id;
            }
        }
    }
</script>
