...
<div id="page-wrapper">
    ...
    <div class="panel panel-default">
        ...
        <!-- /.panel-heading -->
            ...
            <!-- /.table-responsive -->
        <div class="container">
            <form class="xq" action="<?php echo U('Oiladd/add');?>" method="post" enctype="multipart/form-data" onsubmit="return toVaild()" >
                <div class="lei">
                    <p>
                        ...
                        <input class="btn btn-default"
                               ...
                               name="start_time" value="<?php echo ($kilo["start_time"]); ?>" disabled="disabled"style="width: 25%;">
                    </p>
                </div>
                <div class="lei">
                    <p>
                        <label><font>*</font>车牌号：</label>
                        <input class ="sr" type="text"  name="chepai" value="<?php echo ($kilo["chepai"]); ?>"  readonly="readonly"style="width: 25%;"id="chepai"/>
                ...
                <div class="lei">
                    <p>
                        ...
                        <input class ="sr" type="text"  name="chezhu" value="<?php echo ($kilo["chezhu"]); ?>" readonly="readonly" style="width: 25%;" id="chezhu"/>
                ...
                <div class="lei">
                    <p>
                        ...
                        <input class ="sr" type="text"  name="danci" value="<?php echo ($kilo["danci"]); ?>" readonly="readonly"  style="width: 25%;" id="danci"/>
                    </p>
                ...
                <div class="lei">
                    <p>
                        ...
                        <input class ="sr" type="text"  name="danjia" value="<?php echo ($kilo["danjia"]); ?>" readonly="readonly" style="width: 25%;" id="danjia"/>
                    </p>
                ...
                <div class="lei">
                    <p>
                        ...
                        <input class ="sr" type="text"  name="jine" value="<?php echo ($kilo["jine"]); ?>"  readonly="readonly" style="width: 25%;" id="jine"/>
                    </p>

                </div>
                <input type="hidden" name="id" value="<?php echo ($kilo["id"]); ?>">
                <div class="lei">
                    <p>
                        <label><font>*</font>里程：</label>
                        <input class ="sr" type="text"  name="licheng"  value="<?php echo ($kilo["licheng"]); ?>"  style="width: 25%;" id="jine" <?php if($kilo["licheng"] != ''): ?>readonly="readonly"<?php endif; ?>/>
                    </p>
                ...
                <div class="lei">
                    <p>
                        ...
                        <input class ="sr" type="text"  name="beizhu"  value="<?php echo ($kilo["beizhu"]); ?>"  style="width: 25%;" id="jine" <?php if($kilo["beizhu"] != ''): ?>readonly="readonly"<?php endif; ?>/>
                    </p>
