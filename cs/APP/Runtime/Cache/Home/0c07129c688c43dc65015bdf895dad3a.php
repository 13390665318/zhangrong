...
<script>
    ...
    var y_label = "百公里油耗"; //Y轴标题
    var x_label = "时间"; //X轴标题
    var x = [<?php echo ($stu); ?>]; //定义X轴刻度值

    var title = "这是标题"; //统计图标标题
    j.jqplot.diagram.base("chart1", data, line_title,name+" 油耗", x, x_label, y_label, data_max, 1);
    // 两分钟刷新
