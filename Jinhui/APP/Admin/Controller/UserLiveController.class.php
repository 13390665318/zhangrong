        ...
        if($type==1){
            ...
            for($i=0;$i<=$day;$i++){
                for($j=0;$j<count($Parr);$j++){
                    ...
                    $arr[$i][$j]["num"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("a.register_time>='$Strtime' and a.register_time<='$Endtime' and a.source='$source'  and a.game_id=$game_id and a.db_id=$db_id")->count();
                    //2ri
                    ...
                    $arr[$i][$j]["day2"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime2'and b.start_time<='$Endtime2'and a.register_time>='$Strtime' and a.register_time<='$Endtime'and a.source='$source'  and a.game_id=$game_id and a.db_id=$db_id")->count();
                    ...
                    $arr[$i][$j]["day3"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime3'and b.start_time<='$Endtime3' and a.register_time>='$Strtime' and a.register_time<='$Endtime'and a.source='$source'and   a.game_id=$game_id and a.db_id=$db_id")->count();
                    ...
                    $arr[$i][$j]["day4"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime4'and b.start_time<='$Endtime4' and a.register_time>='$Strtime' and a.register_time<='$Endtime'and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
                    ...
                    $arr[$i][$j]["day5"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime5'and b.start_time<='$Endtime5' and a.register_time>='$Strtime' and a.register_time<='$Endtime' and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
                    ...
                    $arr[$i][$j]["day6"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime6'and b.start_time<='$Endtime6' and a.register_time>='$Strtime' and a.register_time<='$Endtime'and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
                    ...
                    $arr[$i][$j]["day7"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime7'and b.start_time<='$Endtime7' and a.register_time>='$Strtime' and a.register_time<='$Endtime'and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
                    ...
                    $arr[$i][$j]["day15"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime15'and b.start_time<='$Endtime15' and a.register_time>='$Strtime' and a.register_time<='$Endtime'and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
                    ...
                    $arr[$i][$j]["day30"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime30'and b.start_time<='$Endtime30' and a.register_time>='$Strtime' and a.register_time<='$Endtime'and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
            ...
            for($i=0;$i<=$day;$i++){
                ...
                $Strtime=date('Y-m-d 00:00:00', strtotime ("+$i day", strtotime($stime)));
                $Endtime=date('Y-m-d 23:59:59', strtotime ("+$i day", strtotime($stime)));
                $arr[$i]["num"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("a.register_time>='$Strtime' and a.register_time<='$Endtime'  and a.game_id=$game_id and a.db_id=$db_id")->count();
                //2ri
                $Strtime2=date('Y-m-d 00:00:00', strtotime ("+1 day", strtotime($Strtime)));
                $Endtime2=date('Y-m-d 23:59:59', strtotime ("+1 day", strtotime($Strtime)));
                $arr[$i]["day2"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("a.register_time>='$Strtime' and a.register_time<='$Endtime' and b.start_time>='$Strtime2'and b.start_time<='$Endtime2' and a.game_id=$game_id and a.db_id=$db_id")->count();
                $arr[$i]["day2s"]=round($arr[$i]["day2"]/$arr[$i]["num"],4)*100;
                //3ri
                $Strtime3=date('Y-m-d 00:00:00', strtotime ("+2 day", strtotime($Strtime)));
                $Endtime3=date('Y-m-d 23:59:59', strtotime ("+2 day", strtotime($Strtime)));
                $arr[$i]["day3"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("a.register_time>='$Strtime' and a.register_time<='$Endtime' and b.start_time>='$Strtime3'and b.start_time<='$Endtime3' and a.game_id=$game_id and a.db_id=$db_id")->count();
                $arr[$i]["day3s"]=round($arr[$i]["day3"]/$arr[$i]["num"],4)*100;
                //4ri
                $Strtime4=date('Y-m-d 00:00:00', strtotime ("+3 day", strtotime($Strtime)));
                $Endtime4=date('Y-m-d 23:59:59', strtotime ("+3 day", strtotime($Strtime)));
                $arr[$i]["day4"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("a.register_time>='$Strtime' and a.register_time<='$Endtime' and b.start_time>='$Strtime4'and b.start_time<='$Endtime4' and a.game_id=$game_id and a.db_id=$db_id")->count();
                $arr[$i]["day4s"]=round($arr[$i]["day4"]/$arr[$i]["num"],4)*100;
                //5
                $Strtime5=date('Y-m-d 00:00:00', strtotime ("+4 day", strtotime($Strtime)));
                $Endtime5=date('Y-m-d 23:59:59', strtotime ("+4 day", strtotime($Strtime)));
                $arr[$i]["day5"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("a.register_time>='$Strtime' and a.register_time<='$Endtime' and b.start_time>='$Strtime5'and b.start_time<='$Endtime5' and a.game_id=$game_id and a.db_id=$db_id")->count();
                $arr[$i]["day5s"]=round($arr[$i]["day5"]/$arr[$i]["num"],4)*100;
                //6
                $Strtime6=date('Y-m-d 00:00:00', strtotime ("+5 day", strtotime($Strtime)));
                $Endtime6=date('Y-m-d 23:59:59', strtotime ("+5 day", strtotime($Strtime)));
                $arr[$i]["day6"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("a.register_time>='$Strtime' and a.register_time<='$Endtime' and b.start_time>='$Strtime6'and b.start_time<='$Endtime6' and a.game_id=$game_id and a.db_id=$db_id")->count();
                $arr[$i]["day6s"]=round($arr[$i]["day6"]/$arr[$i]["num"],4)*100;
                //7
                $Strtime7=date('Y-m-d 00:00:00', strtotime ("+6 day", strtotime($Strtime)));
                $Endtime7=date('Y-m-d 23:59:59', strtotime ("+6 day", strtotime($Strtime)));
                $arr[$i]["day7"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("a.register_time>='$Strtime' and a.register_time<='$Endtime' and b.start_time>='$Strtime7'and b.start_time<='$Endtime7' and a.game_id=$game_id and a.db_id=$db_id")->count();
                $arr[$i]["day7s"]=round($arr[$i]["day7"]/$arr[$i]["num"],4)*100;
                //15
                $Strtime15=date('Y-m-d 00:00:00', strtotime ("+14 day", strtotime($Strtime)));
                $Endtime15=date('Y-m-d 23:59:59', strtotime ("+14 day", strtotime($Strtime)));
                $arr[$i]["day15"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("a.register_time>='$Strtime' and a.register_time<='$Endtime' and b.start_time>='$Strtime15'and b.start_time<='$Endtime15' and a.game_id=$game_id and a.db_id=$db_id")->count();
                $arr[$i]["day15s"]=round($arr[$i]["day15"]/$arr[$i]["num"],4)*100;
                //30
                $Strtime30=date('Y-m-d 00:00:00', strtotime ("+29 day", strtotime($Strtime)));
                $Endtime30=date('Y-m-d 23:59:59', strtotime ("+29 day", strtotime($Strtime)));
                $arr[$i]["day30"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("a.register_time>='$Strtime' and a.register_time<='$Endtime' and b.start_time>='$Strtime30'and b.start_time<='$Endtime30' and a.game_id=$game_id and a.db_id=$db_id")->count();
            ...
            for($j=0;$j<count($Parr);$j++) {
                ...
                $Endtime=date('Y-m-d 23:59:59', strtotime ("+0 day", strtotime($etime)));
                $arr[$j]["name"]=$Parr[$j];
                $arr[$j]["num"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("a.register_time>='$Strtime' and a.register_time<='$Endtime' and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();

                //2ri
                $Strtime2=date('Y-m-d 00:00:00', strtotime ("+1 day", strtotime($Strtime)));
                $Endtime2=date('Y-m-d 23:59:59', strtotime ("+1 day", strtotime($Strtime)));
                $arr[$j]["day2"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime2'and b.start_time<='$Endtime2' and a.register_time>='$Strtime' and a.register_time<='$Endtime'  and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
                 $arr[$j]["day2s"]=round($arr[$j]["day2"]/$arr[$j]["num"],4)*100;
                //3ri
                $Strtime3=date('Y-m-d 00:00:00', strtotime ("+2 day", strtotime($Strtime)));
                $Endtime3=date('Y-m-d 23:59:59', strtotime ("+2 day", strtotime($Strtime)));
                $arr[$j]["day3"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime3'and b.start_time<='$Endtime3' and a.register_time>='$Strtime' and a.register_time<='$Endtime'  and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
                $arr[$j]["day3s"]=round($arr[$j]["day3"]/$arr[$j]["num"],4)*100;
                //4ri
                $Strtime4=date('Y-m-d 00:00:00', strtotime ("+3 day", strtotime($Strtime)));
                $Endtime4=date('Y-m-d 23:59:59', strtotime ("+3 day", strtotime($Strtime)));
                $arr[$j]["day4"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime4'and b.start_time<='$Endtime4' and a.register_time>='$Strtime' and a.register_time<='$Endtime'  and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
                $arr[$j]["day4s"]=round($arr[$j]["day4"]/$arr[$j]["num"],4)*100;
                //5
                $Strtime5=date('Y-m-d 00:00:00', strtotime ("+4 day", strtotime($Strtime)));
                $Endtime5=date('Y-m-d 23:59:59', strtotime ("+4 day", strtotime($Strtime)));
                $arr[$j]["day5"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime5'and b.start_time<='$Endtime5' and a.register_time>='$Strtime' and a.register_time<='$Endtime'  and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
                $arr[$j]["day5s"]=round($arr[$j]["day5"]/$arr[$j]["num"],4)*100;
                //6
                $Strtime6=date('Y-m-d 00:00:00', strtotime ("+5 day", strtotime($Strtime)));
                $Endtime6=date('Y-m-d 23:59:59', strtotime ("+5 day", strtotime($Strtime)));
                $arr[$j]["day6"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime6'and b.start_time<='$Endtime6' and a.register_time>='$Strtime' and a.register_time<='$Endtime'  and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
                $arr[$j]["day6s"]=round($arr[$j]["day6"]/$arr[$j]["num"],4)*100;
                //7
                $Strtime7=date('Y-m-d 00:00:00', strtotime ("+6 day", strtotime($Strtime)));
                $Endtime7=date('Y-m-d 23:59:59', strtotime ("+6 day", strtotime($Strtime)));
                $arr[$j]["day7"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime7'and b.start_time<='$Endtime7' and a.register_time>='$Strtime' and a.register_time<='$Endtime'  and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
                $arr[$j]["day7s"]=round($arr[$j]["day7"]/$arr[$j]["num"],4)*100;
                //15
                $Strtime15=date('Y-m-d 00:00:00', strtotime ("+14 day", strtotime($Strtime)));
                $Endtime15=date('Y-m-d 23:59:59', strtotime ("+14 day", strtotime($Strtime)));
                $arr[$j]["day15"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime15'and b.start_time<='$Endtime15' and a.register_time>='$Strtime' and a.register_time<='$Endtime'  and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
                $arr[$j]["day15s"]=round($arr[$j]["day15"]/$arr[$j]["num"],4)*100;
                //30
                $Strtime30=date('Y-m-d 00:00:00', strtotime ("+29 day", strtotime($Strtime)));
                $Endtime30=date('Y-m-d 23:59:59', strtotime ("+29 day", strtotime($Strtime)));
                $arr[$j]["day30"]=M('user as a','',$connection)->join('sign  as  b  on b.game_user_id = a.game_user_id')->where("b.start_time>='$Strtime30'and b.start_time<='$Endtime30' and a.register_time>='$Strtime' and a.register_time<='$Endtime'  and a.source='$source' and a.game_id=$game_id and a.db_id=$db_id")->count();
