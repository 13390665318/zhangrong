...
class InvitationController extends BaseController
{
    ...
    public function add(){
        if(isset($_POST["sub"])){
            ...
            $arr["goods_nums"]=I("post.goods_nums");
    ...
    public function find(){
        if(isset($_GET["code"])){
            ...
            for($i=0;$i<count($arr);$i++){
                ...
                $goods_ids=$tyStu["goods_ids"];
                $goods_nums=$tyStu["goods_nums"];
                $goods=explode(',',$goods_ids);
                $nums=explode(',',$goods_nums);
                $stu="";
                for($j=0;$j<count($goods);$j++){
