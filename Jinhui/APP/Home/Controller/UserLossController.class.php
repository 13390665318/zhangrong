...
class UserLossController extends BaseController
{
    ...
    public function index(){
        ...
        $arr=D("usersave")->where("db_id=$db_id and time>='$stime' and time <='$etime' ")->order("time asc")->select();
