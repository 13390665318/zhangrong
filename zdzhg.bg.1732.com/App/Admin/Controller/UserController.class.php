...
class UserController extends CommonController {
	...
	public function roleAdd(){
		if(IS_POST){
			...
			$res ? $this->success(L("public_return_add_success")) : $this->error(L("public_return_add_error"));
		}else{
	...
	public function roleEdit(){
		...
		if(IS_POST){
			...
			$res ? $this->success(L("public_return_edit_success")) : $this->error(L("public_return_edit_error"));
		}else{
			$roleid = I('get.id');
	...
	public function roleDelete($ids = ''){
		if(IS_POST){
			...
			if ($result){
				...
				$this->success(L("public_return_delete_success"));
			}else {
				$this->error(L("public_return_delete_error"));
			}
		}
	}
	...
	public function userAdd(){
		if(IS_POST){
			...
			if($id){
				...
				$this->success(L("public_return_add_success"));
			}else {
				$this->error(L("public_return_add_error"));
			}
		}else{
			$admin_role_db = D('AdminRole');
	...
	public function userDelete($ids = ''){
		if(IS_POST){
			...
			$res ? $this->success(L("public_return_delete_success")) : $this->error(L("public_return_delete_error"));
		}
	}
