...
class CategoryController extends CommonController {
	...
	public function categoryAdd(){
		if(IS_POST){
			...
			$status ? $this->success(L("public_return_add_success")) : $this->error(L("public_return_add_error"));
		}else{
	...
	public function categoryEdit(){
		...
		if(IS_POST){
			...
			$status ? $this->success(L("public_return_edit_success")) : $this->error(L("public_return_edit_error"));
		}else{
			$id   = I('get.id');
