define(['common/cookie'], function(cookie){
	return {
		...
		messager: {
		    title: language.public_prompt_information,
			timeout  : 3000,
			showType : 'slide'
		},
		...
		propertygrid: {
			...
			//scrollbarSize : 0,
			columns       : [[
				{field: 'name', title: language.public_name, width: 80, sortable: true},
				{field: 'value', title: language.public_parameter, width: 200, sortable: false, formatter:function(value, arr){
					var editor = '';
