	...
	var module = {
		...
		dialog: {
			...
			form: function(e, merge, success, error){
				...
				option['buttons'] = [{
				    text: language.public_determine,
					iconCls: 'fa fa-check',
					handler: function(){
				    ...
				    text: language.public_use_cancel,
					iconCls: 'fa fa-close',
					handler: function(){
						$(_this.dialog).dialog('close');
					}
			...
			event: {
				toolbar: function(e, obj){
					...
					$('.toolbar-search', selecter).on('click', function () {
						...
						option.content = '<table class="easyui-propertygrid" data-options="data:' + data + ',showGroup:' + showGroup + ',border:false,fit:true,scrollbarSize:' + scrollbar + ',columns:[[{field:\'name\',title:\'' + language.public_field_name + '\',width:100},{field:\'value\',title:\'' + language.public_screening_conditions + '\',width:200}]]"></table>';
